...
int parse_arguments(Chip8 &chip8,
                    int argc,
                    char *argv[],
...
{
    std::string emulator_usage{
        "Usage: /path/to/chip8.exe /path/to/rom<string> cycle_delay<int> window_scale<int> --cosmac(optional) "
        "--amiga(optional) --mute(optional)"};
